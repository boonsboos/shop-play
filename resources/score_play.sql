...
--
-- Host: mariadb
-- Gegenereerd op: 20 okt 2025 om 19:10
...
--
ALTER TABLE `friends`
  ADD UNIQUE KEY `UQ_user_id_friends_id` (`user_id`,`friend_id`) USING BTREE,
...
ALTER TABLE `game_followers`
  ADD UNIQUE KEY `UQ_game_id_user_id` (`game_id`,`user_id`),
...
ALTER TABLE `game_pictures`
  ADD UNIQUE KEY `UQ_picture_id` (`picture_id`),
...
ALTER TABLE `pictures`
  ...
  ADD UNIQUE KEY `UQ_picture_url` (`picture_url`) USING HASH;
...
ALTER TABLE `scores`
  ...
  ADD UNIQUE KEY `UQ_session_score` (`session_id`,`session_player_id`,`turn`),
...
ALTER TABLE `sessions`
  ...
  ADD UNIQUE KEY `UQ_end_of_session_picture_id` (`end_of_session_picture_id`),
...
ALTER TABLE `session_players`
  ...
  ADD UNIQUE KEY `UQ_user_id_guest_name` (`user_id`,`guest_name`),
